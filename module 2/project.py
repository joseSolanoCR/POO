class Patient:
    ...
    def __init__(self, first_name, last_name, address, phone, total_charges):
...
class PaymentProcessor:
    ...
    def print_patient_dues(self):
        ...
        for patient in self.list_of_patients:
            print("{:15} {:15} {:15} {:20}".format(patient.last_name, patient.first_name, patient.total_charges,
                                                   patient.calculate_payment()))
